...
titleElem.className = "text-2xl font-bold mt-32";
titleElem.textContent = `Total data: ${pizzaData.length} ədəd pizza`;

productsElem.parentNode.insertBefore(titleElem, productsElem);

pizzaData.forEach((product) => {
  productsElem.innerHTML += `
        <div class = "border-md rounded-md shadow-md p-4 m-2">
        <img src="${product.img}"  class="w-full h-48 object-cover mb-4 align-center">
        <i class="fa-solid fa-bag-shopping"></i>
        <h2>${product.name}</h2>
         <span class= "red">${product.price} AZN </span>
            `;
});
